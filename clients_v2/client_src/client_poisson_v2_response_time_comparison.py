...
if __name__ == "__main__":
    ...
    for loop in range(1, loops + 1):
        ...
        draw(title='comparison', x_labels=algo_names, data=[
            {'label': 'total_response_time', 'values': [program_config["results"][algo_name]['total_response_time'] for algo_name in algo_names]},
        ], save_path=program_config['file_path_config']['total_response_time']['path'], file_name=program_config['file_path_config']['total_response_time']['filename'])
